				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Dashboard </span> - Product Damage Report</h4>
						</div>
					</div>
				...
				<div class="content">
					<div class="panel panel-body ">
						<form class="heading-form" id="form-sales" method="POST">
							<input type="hidden" name="submit-damage-report">
							<ul class="breadcrumb-elements" style="float:left">
								<li style="padding-top: 2px;padding-right: 2px">
									<div class="input-group">
										<span class="input-group-addon"><i class="icon-calendar"></i></span>
										<input type="text" autocomplete="off" name="date" class="form-control daterange-buttons" value=" <?php if (isset($_SESSION['damage-report']) != "") { ?>   <?= $_SESSION['damage-report'] ?> <?php } else { ?> <?= date("m-d-Y") ?> - <?= date("m-d-Y") ?>  <?php } ?>">
									</div>
								</li>
					...
					<div class="panel panel-white border-top-xlg border-top-teal-400">
						<div class="panel-heading">
							<h6 class="panel-title"><i class="icon-chart text-teal-400"></i> List of product damage report <a class="heading-elements-toggle"><i class="icon-more"></i></a></h6>
						</div>
...
<script type="text/javascript">
	...
	$(function() {
		...
		var oTable = $('.datatable-button-html5-basic').DataTable({
			...
			"ajax": {
				url: "../transaction.php?damage-report",
				type: 'POST',
