                    ...
                    <div class="panel panel-body ">
                        <form class="heading-form" id="form-sales" method="POST">
                            ...
                            <ul class="breadcrumb-elements" style="float:left" >
                                ...
                                <li data-toggle="tooltip" title="Export Excel" style="padding-top: 2px;padding-right: 2px;margin-left:-18px"><button type="button"  onClick="window.location.href='downloadPDF.php?type=inventory&export=excel&backlink=inventory-report.php'" class="btn bg-success-700"><b><i class="icon-file-excel"></i></b></button></li>
                                <li data-toggle="tooltip" title="Export PDF" style="padding-top: 2px;padding-right: 2px"><button type="button" onClick="window.location.href='downloadPDF.php?type=inventory&export=pdf&backlink=inventory-report.php'"  class="btn bg-danger-700"><b><i class="icon-file-pdf"></i></b></button></li>
                            </ul>
                        </form>
                    </div>
...
<script type="text/javascript">
   var image = '<img src="../images/LoaderIcon.gif" >';
	$(function() {
	    ...
	    var oTable = $('.datatable-button-html5-basic').DataTable({
		   ...
		   /* "stateSave": true,*/ //restore table state on page reload, 
	        ...
	        // ],
		    "ajax": {
		        url : "../transaction.php?inventory-report",
		        type: 'POST',
	...
	function  view_details_recieving(el)
	{
